...
- Additionally, the Sales Order data have to be enriched with Customer master data, initially and then on every change committed to the EPM Sales Order objects.
