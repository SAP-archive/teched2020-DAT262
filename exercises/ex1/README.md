...
(As a reminder: You can recap the relationship between the relevant EPM table entities [here](../ex0#short-introduction-to-the-enterprise-procurement-model-epm-in-s4))
