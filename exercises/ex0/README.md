...
- For this reason, all parts of this session that require these (local) applications will be presented as live ***Deep Dive demos***, conducted in ADT and on SAP S/4HANA **by the trainer**,
