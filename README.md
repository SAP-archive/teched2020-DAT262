...
In case you have problems with implementing the pipelines, you can download the example pipelines here (right-click --> save link as...). The JSON file can be imported as Pipelines in the Data Intelligence Modeler.
